import { createWebPersonalServer } from "./api"
  ...
  get(filters: {
    ...
    if (filters.cursor === "a1") {
      return new PaginatedClasses([
        ...
        new Class(4, filters.includeTeachers ? [this.teacher2, this.teacher3] : undefined),
      ], "a2", true)
    }
    ...
    return new PaginatedClasses([
      new Class(1, filters.includeTeachers ? [this.teacher1, this.teacher2] : undefined),
...
const port = 3000
createWebPersonalServer(new HardcodedClasses()).listen(port, () => {
